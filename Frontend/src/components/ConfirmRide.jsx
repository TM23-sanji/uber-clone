  ...
  return (
    <div>
        ...
        <div className='flex flex-col gap-2 justify-between items-center'>
            ...
            <button onClick={()=>{props.setVehicleFound(true), props.setConfirmRidePanel(false)}} className='w-full bg-green-600 text-white font-semibold p-2 rounded-lg'>Confirm</button>
        </div>
